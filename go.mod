...
replace (
	...
	github.com/external-secrets/external-secrets/providers/v1/dm => ./providers/v1/dm
...
require (
	...
	github.com/external-secrets/external-secrets/providers/v1/dm v0.0.0-00010101000000-000000000000
