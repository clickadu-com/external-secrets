...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CertificateCreationParams) DeepCopyInto(out *CertificateCreationParams) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CertificateCreationParams.
func (in *CertificateCreationParams) DeepCopy() *CertificateCreationParams {
	if in == nil {
		return nil
	}
	out := new(CertificateCreationParams)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ExternalSecretDataRemoteRef) DeepCopyInto(out *ExternalSecretDataRemoteRef) {
	*out = *in
	if in.CreationParams != nil {
		in, out := &in.CreationParams, &out.CreationParams
		*out = new(CertificateCreationParams)
		**out = **in
	}
}
